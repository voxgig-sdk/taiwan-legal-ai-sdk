...
// TaiwanLegalAi SDK netsim feature
...
class TaiwanLegalAiNetsimFeature extends TaiwanLegalAiBaseFeature
{
    ...
    private function _simulate(TaiwanLegalAiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TaiwanLegalAiContext $ctx, array $applied): void
    {
        $client = $this->client;
