...
// TaiwanLegalAi SDK clienttrack feature
...
class TaiwanLegalAiClienttrackFeature extends TaiwanLegalAiBaseFeature
{
    ...
    public function PostConstruct(TaiwanLegalAiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TaiwanLegalAi-SDK';
