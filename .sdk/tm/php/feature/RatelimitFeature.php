...
// TaiwanLegalAi SDK ratelimit feature
...
class TaiwanLegalAiRatelimitFeature extends TaiwanLegalAiBaseFeature
{
    ...
    private function _acquire(TaiwanLegalAiContext $ctx): void
    {
    ...
    private function _track(TaiwanLegalAiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
