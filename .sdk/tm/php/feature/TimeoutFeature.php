...
// TaiwanLegalAi SDK timeout feature
...
class TaiwanLegalAiTimeoutFeature extends TaiwanLegalAiBaseFeature
{
    ...
    private function _with_timeout(TaiwanLegalAiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TaiwanLegalAiContext $_ctx, float $ms): void
    {
        $client = $this->client;
