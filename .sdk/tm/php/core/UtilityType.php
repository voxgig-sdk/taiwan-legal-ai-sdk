...
// TaiwanLegalAi SDK utility type

class TaiwanLegalAiUtility
{
    ...
    public static function copy(TaiwanLegalAiUtility $src): TaiwanLegalAiUtility
    {
        $u = new TaiwanLegalAiUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
