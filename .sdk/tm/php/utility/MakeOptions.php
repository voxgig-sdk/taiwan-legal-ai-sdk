...
// TaiwanLegalAi SDK utility: make_options

class TaiwanLegalAiMakeOptions
{
    ...
    public static function call(TaiwanLegalAiContext $ctx): array
    {
        ...
        //
        // `TaiwanLegalAiSchema::optspec()` is built from the model:
        ...
        $optspec = TaiwanLegalAiSchema::optspec();
