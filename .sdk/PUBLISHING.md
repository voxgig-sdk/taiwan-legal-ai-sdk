...
|---|---|---|
| `ts/` | @voxgig-sdk/taiwan-legal-ai-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/taiwan-legal-ai-sdk \
      --repository voxgig-sdk/taiwan-legal-ai-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/taiwan-legal-ai-sdk` shows it, and
`npm trust revoke @voxgig-sdk/taiwan-legal-ai-sdk --id=<id>` removes it.
