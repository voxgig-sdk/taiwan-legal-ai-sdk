// Command TaiwanLegalAi-mcp is an MCP server exposing the TaiwanLegalAi
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TaiwanLegalAi_list  — list records of an entity
//	TaiwanLegalAi_load  — load a single record of an entity
//
...
func main() {
	...
	client := sdk.NewTaiwanLegalAiSDK(nil)
