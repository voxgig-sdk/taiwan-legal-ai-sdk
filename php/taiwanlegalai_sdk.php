...
class TaiwanLegalAiSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = TaiwanLegalAiHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = TaiwanLegalAiHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!TaiwanLegalAiFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, TaiwanLegalAiFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return TaiwanLegalAiUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = TaiwanLegalAiHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = TaiwanLegalAiHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = TaiwanLegalAiHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new TaiwanLegalAiError($op . "_allow",
                "TaiwanLegalAiSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = TaiwanLegalAiHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new TaiwanLegalAiError("graphql_error",
                "TaiwanLegalAiSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function CaseAnalysi($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_case_analysi === null) {
                $this->_case_analysi = new CaseAnalysiEntity($this, null);
            }
            return $this->_case_analysi;
        }
        return new CaseAnalysiEntity($this, $data);
    }
    ...
    public function ContractService($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_contract_service === null) {
                $this->_contract_service = new ContractServiceEntity($this, null);
            }
            return $this->_contract_service;
        }
        return new ContractServiceEntity($this, $data);
    }
    ...
    public function LegalQuery($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_legal_query === null) {
                $this->_legal_query = new LegalQueryEntity($this, null);
            }
            return $this->_legal_query;
        }
        return new LegalQueryEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new TaiwanLegalAiSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
