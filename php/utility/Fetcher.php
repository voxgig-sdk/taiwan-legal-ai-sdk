...
// TaiwanLegalAi SDK utility: fetcher

class TaiwanLegalAiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TaiwanLegalAiSDK/1.0)';
    ...
    public static function call(TaiwanLegalAiContext $ctx, string $fullurl, array $fetchdef): array
    {
