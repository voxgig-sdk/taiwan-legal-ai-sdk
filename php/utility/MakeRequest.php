...
// TaiwanLegalAi SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TaiwanLegalAiMakeRequest
{
    public static function call(TaiwanLegalAiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TaiwanLegalAiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TaiwanLegalAiResponse($fetched);
        } else {
