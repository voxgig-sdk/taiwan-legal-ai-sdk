...
// TaiwanLegalAi SDK utility: graphql
//
...
class TaiwanLegalAiGraphql
{
    ...
    // equivalent.
    public static function body(TaiwanLegalAiContext $ctx): mixed
    {
    ...
    public static function errors(TaiwanLegalAiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
