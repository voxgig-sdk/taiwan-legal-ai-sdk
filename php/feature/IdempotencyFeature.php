...
// TaiwanLegalAi SDK idempotency feature
...
class TaiwanLegalAiIdempotencyFeature extends TaiwanLegalAiBaseFeature
{
    ...
    private function _mutating(TaiwanLegalAiContext $ctx): bool
    {
