...
// TaiwanLegalAi SDK cache feature
...
class TaiwanLegalAiCacheFeature extends TaiwanLegalAiBaseFeature
{
    ...
    private function _through(TaiwanLegalAiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
