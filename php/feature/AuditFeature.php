...
// TaiwanLegalAi SDK audit feature
...
class TaiwanLegalAiAuditFeature extends TaiwanLegalAiBaseFeature
{
    ...
    private function _emit(TaiwanLegalAiContext $ctx, string $outcome): void
    {
