...
// TaiwanLegalAi SDK proxy feature
...
class TaiwanLegalAiProxyFeature extends TaiwanLegalAiBaseFeature
{
    ...
    public function init(TaiwanLegalAiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TaiwanLegalAiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
