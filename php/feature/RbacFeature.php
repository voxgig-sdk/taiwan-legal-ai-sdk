...
// TaiwanLegalAi SDK rbac feature
...
class TaiwanLegalAiRbacFeature extends TaiwanLegalAiBaseFeature
{
    ...
    private function _required(TaiwanLegalAiContext $ctx): ?string
    {
    ...
    private function _reject(TaiwanLegalAiContext $ctx, string $required): void
    {
    ...
    private function _track(TaiwanLegalAiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
