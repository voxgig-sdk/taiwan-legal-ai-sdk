...
// TaiwanLegalAi SDK telemetry feature
...
class TaiwanLegalAiTelemetryFeature extends TaiwanLegalAiBaseFeature
{
    ...
    private function _close(TaiwanLegalAiContext $ctx, bool $ok): void
    {
