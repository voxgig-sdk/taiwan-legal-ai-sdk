...
// TaiwanLegalAi SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TaiwanLegalAiOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TaiwanLegalAiOmni::structfix($now, Struct::undef()))
                        !== json_encode(TaiwanLegalAiOmni::structfix($val, Struct::undef()))) {
