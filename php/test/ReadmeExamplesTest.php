...
// TaiwanLegalAi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TaiwanLegalAiSDK::test)
...
{
    private const SDK_CLASS = 'TaiwanLegalAiSDK';
    ...
    private const SDK_BASE = 'taiwanlegalai_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../taiwanlegalai_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
