...
class ContractServiceEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TAIWANLEGALAI_TEST_CONTRACT_SERVICE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function contract_service_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TAIWANLEGALAI_TEST_CONTRACT_SERVICE_ENTID");
