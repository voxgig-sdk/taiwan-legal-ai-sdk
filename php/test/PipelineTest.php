...
// TaiwanLegalAi SDK pipeline test
//
...
{
    private static function utility(): TaiwanLegalAiUtility
    {
        return new TaiwanLegalAiUtility();
    }
    ...
    private static function ctx(array $over = []): TaiwanLegalAiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new TaiwanLegalAiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new TaiwanLegalAiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof TaiwanLegalAiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new TaiwanLegalAiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = TaiwanLegalAiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new TaiwanLegalAiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = TaiwanLegalAiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new TaiwanLegalAiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = TaiwanLegalAiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TaiwanLegalAiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = TaiwanLegalAiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new TaiwanLegalAiResponse([]),
            'result' => new TaiwanLegalAiResult([]),
        ]);
        [, $err] = TaiwanLegalAiMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new TaiwanLegalAiSpec([]),
            'response' => null,
            'result' => new TaiwanLegalAiResult([]),
        ]);
        [, $err] = TaiwanLegalAiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new TaiwanLegalAiSpec(['step' => 's']),
            'response' => new TaiwanLegalAiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new TaiwanLegalAiResult([]),
        ]);
        [, $err] = TaiwanLegalAiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new TaiwanLegalAiSpec(['step' => 's']),
            'response' => new TaiwanLegalAiResponse(self::resp(200, ['v' => 1])),
            'result' => new TaiwanLegalAiResult([]),
        ]);
        [, $err] = TaiwanLegalAiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new TaiwanLegalAiSpec(['step' => 's']),
            'response' => new TaiwanLegalAiResponse(self::resp(200, ['v' => 2])),
            'result' => new TaiwanLegalAiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        TaiwanLegalAiMakeResponse::call($ctx);
    ...
    {
        $preset = new TaiwanLegalAiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new TaiwanLegalAiSpec([]),
            'response' => new TaiwanLegalAiResponse([]),
            'result' => new TaiwanLegalAiResult([]),
        ...
        [$got, $err] = TaiwanLegalAiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new TaiwanLegalAiResult([])]);
        [, $err] = TaiwanLegalAiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new TaiwanLegalAiSpec([]), 'result' => null]);
        [, $err] = TaiwanLegalAiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TaiwanLegalAiSpec(['step' => 's']),
            'result' => new TaiwanLegalAiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new TaiwanLegalAiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TaiwanLegalAiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TaiwanLegalAiSpec(['step' => 's']),
            'result' => new TaiwanLegalAiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new TaiwanLegalAiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TaiwanLegalAiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TaiwanLegalAiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new TaiwanLegalAiSpec([]),
            'result' => new TaiwanLegalAiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = TaiwanLegalAiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TaiwanLegalAiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new TaiwanLegalAiError('boom', 'boom');
        $utility->fetcher = function (TaiwanLegalAiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TaiwanLegalAiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = TaiwanLegalAiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (TaiwanLegalAiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = TaiwanLegalAiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(TaiwanLegalAiResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        TaiwanLegalAiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (TaiwanLegalAiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TaiwanLegalAiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = TaiwanLegalAiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new TaiwanLegalAiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new TaiwanLegalAiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = TaiwanLegalAiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = TaiwanLegalAiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = TaiwanLegalAiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new TaiwanLegalAiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, TaiwanLegalAiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new TaiwanLegalAiResult(['ok' => false])]);
        $this->expectException(TaiwanLegalAiError::class);
        TaiwanLegalAiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new TaiwanLegalAiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', TaiwanLegalAiMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        TaiwanLegalAiMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new TaiwanLegalAiBaseFeature();
        $b = new TaiwanLegalAiBaseFeature();
        TaiwanLegalAiFeatureAdd::call($ctx, $a);
        TaiwanLegalAiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): TaiwanLegalAiBaseFeature
    {
        $f = new TaiwanLegalAiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        TaiwanLegalAiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): TaiwanLegalAiContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new TaiwanLegalAiSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TaiwanLegalAiPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        TaiwanLegalAiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new TaiwanLegalAiResponse(['headers' => null]),
            'result' => new TaiwanLegalAiResult([]),
        ]);
        TaiwanLegalAiResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        TaiwanLegalAiResultBody::call($ctx);
