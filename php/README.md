# TaiwanLegalAi PHP SDK

The PHP SDK for the TaiwanLegalAi API. Provides an entity-oriented interface using PHP conventions.
...
```php
// Create
[$created, $_] = $client->CaseAnalysi(null)->create(["name" => "Example"], null);
...
[$result, $err] = $client->TaiwanLegalAi(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── taiwanlegalai_sdk.php          -- Main SDK class
...
The main class (`taiwanlegalai_sdk.php`) exports the SDK class
