...
exports.TaiwanLegalAiEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends TaiwanLegalAiEntityBase<Advice>`.
class TaiwanLegalAiEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.TaiwanLegalAiEntityBase = TaiwanLegalAiEntityBase;
//# sourceMappingURL=TaiwanLegalAiEntityBase.js.map