...
const testSeed = `map[string]any{"entity": map[string]any{"case_analysi": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "contract_service": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "legal_query": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
