...
// instead of `sdk.NewTaiwanLegalAiSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *TaiwanLegalAiSDK  { return NewTaiwanLegalAiSDK(nil) }
func Test() *TaiwanLegalAiSDK { return TestSDK(nil, nil) }
