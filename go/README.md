...
## Install
```bash
go get github.com/voxgig-sdk/taiwan-legal-ai-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/taiwan-legal-ai-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/taiwan-legal-ai-sdk/go=../taiwan-legal-ai-sdk/go
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *TaiwanLegalAiSDK
```
...
| `CaseAnalysi` | `(data map[string]any) TaiwanLegalAiEntity` | Create a CaseAnalysi entity instance. |
| `ContractService` | `(data map[string]any) TaiwanLegalAiEntity` | Create a ContractService entity instance. |
| `LegalQuery` | `(data map[string]any) TaiwanLegalAiEntity` | Create a LegalQuery entity instance. |

### Entity interface (TaiwanLegalAiEntity)

All entities implement the `TaiwanLegalAiEntity` interface.
...
| `parties` | `map[string]any` | Information about parties involved |
...
| `complianceCheck` | `map[string]any` | Compliance with Taiwan laws |
...
| `parties` | `map[string]any` | Information about contracting parties |
...
```
github.com/voxgig-sdk/taiwan-legal-ai-sdk/go/
├── taiwan-legal-ai.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/taiwan-legal-ai-sdk/go`) re-exports everything needed
