...
func NewCaseAnalysiEntity(client *core.TaiwanLegalAiSDK, entopts map[string]any) *CaseAnalysiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CaseAnalysiEntity) GetName() string { return e.name }
...
func (e *CaseAnalysiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CaseAnalysiEntity) Deleted() bool {
	return e.deleted
}


func (e *CaseAnalysiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCaseAnalysiEntity(e.client, opts)
}

func (e *CaseAnalysiEntity) Data(args ...any) any {
...
func (e *CaseAnalysiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CaseAnalysi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CaseAnalysiEntity) DataTyped(data ...CaseAnalysi) CaseAnalysi {
	if len(data) > 0 {
		return typedFrom[CaseAnalysi](e.Data(asMap(data[0])))
	}
	return typedFrom[CaseAnalysi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CaseAnalysi (all fields
// optional at the wire level).
func (e *CaseAnalysiEntity) MatchTyped(match ...CaseAnalysi) CaseAnalysi {
	if len(match) > 0 {
		return typedFrom[CaseAnalysi](e.Match(asMap(match[0])))
	}
	return typedFrom[CaseAnalysi](e.Match())
}
...
func (e *CaseAnalysiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CaseAnalysiEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CaseAnalysiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CaseAnalysiEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CaseAnalysiCreateData and returns an CaseAnalysi. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CaseAnalysiEntity) CreateTyped(reqdata CaseAnalysiCreateData, ctrl map[string]any) (CaseAnalysi, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CaseAnalysi{}, err
	}
	return typedFrom[CaseAnalysi](res), nil
}



func (e *CaseAnalysiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CaseAnalysiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CaseAnalysiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
