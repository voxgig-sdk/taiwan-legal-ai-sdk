...
type ContractServiceEntity struct {
	name    string
	client  *core.TaiwanLegalAiSDK
...
func NewContractServiceEntity(client *core.TaiwanLegalAiSDK, entopts map[string]any) *ContractServiceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContractServiceEntity) GetName() string { return e.name }
...
func (e *ContractServiceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ContractServiceEntity) Deleted() bool {
	return e.deleted
}


func (e *ContractServiceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewContractServiceEntity(e.client, opts)
}

func (e *ContractServiceEntity) Data(args ...any) any {
...
func (e *ContractServiceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ContractService; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ContractServiceEntity) DataTyped(data ...ContractService) ContractService {
	if len(data) > 0 {
		return typedFrom[ContractService](e.Data(asMap(data[0])))
	}
	return typedFrom[ContractService](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ContractService (all fields
// optional at the wire level).
func (e *ContractServiceEntity) MatchTyped(match ...ContractService) ContractService {
	if len(match) > 0 {
		return typedFrom[ContractService](e.Match(asMap(match[0])))
	}
	return typedFrom[ContractService](e.Match())
}
...
func (e *ContractServiceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ContractServiceEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ContractServiceEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ContractServiceEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContractServiceCreateData and returns an ContractService. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ContractServiceEntity) CreateTyped(reqdata ContractServiceCreateData, ctrl map[string]any) (ContractService, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ContractService{}, err
	}
	return typedFrom[ContractService](res), nil
}



func (e *ContractServiceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ContractServiceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ContractServiceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
