...
func NewLegalQueryEntity(client *core.TaiwanLegalAiSDK, entopts map[string]any) *LegalQueryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LegalQueryEntity) GetName() string { return e.name }
...
func (e *LegalQueryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LegalQueryEntity) Deleted() bool {
	return e.deleted
}


func (e *LegalQueryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLegalQueryEntity(e.client, opts)
}

func (e *LegalQueryEntity) Data(args ...any) any {
...
func (e *LegalQueryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LegalQuery; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LegalQueryEntity) DataTyped(data ...LegalQuery) LegalQuery {
	if len(data) > 0 {
		return typedFrom[LegalQuery](e.Data(asMap(data[0])))
	}
	return typedFrom[LegalQuery](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LegalQuery (all fields
// optional at the wire level).
func (e *LegalQueryEntity) MatchTyped(match ...LegalQuery) LegalQuery {
	if len(match) > 0 {
		return typedFrom[LegalQuery](e.Match(asMap(match[0])))
	}
	return typedFrom[LegalQuery](e.Match())
}
...
func (e *LegalQueryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LegalQueryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *LegalQueryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *LegalQueryEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LegalQueryCreateData and returns an LegalQuery. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *LegalQueryEntity) CreateTyped(reqdata LegalQueryCreateData, ctrl map[string]any) (LegalQuery, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return LegalQuery{}, err
	}
	return typedFrom[LegalQuery](res), nil
}



func (e *LegalQueryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LegalQueryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LegalQueryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
