...
class CaseAnalysiEntity
  ...
  def make
    opts = @_entopts.dup
    CaseAnalysiEntity.new(@_client, opts)
  end
  ...
  # @return [CaseAnalysi, Hash] the current CaseAnalysi data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CaseAnalysi fields)
  def match_get
  ...
  #
  # @param reqdata [CaseAnalysiCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CaseAnalysi, Hash] the created CaseAnalysi; raises TaiwanLegalAiError on failure
