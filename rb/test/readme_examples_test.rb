...
#      offline in seeded test mode (TaiwanLegalAiSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TaiwanLegalAi_sdk.rb")
  SDK_CLASS = "TaiwanLegalAiSDK"
