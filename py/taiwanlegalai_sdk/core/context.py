...
from taiwanlegalai_sdk.core.helpers import get_ctx_prop, to_map
...
class TaiwanLegalAiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = TaiwanLegalAiControl()
        ...
        if isinstance(sp, TaiwanLegalAiSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TaiwanLegalAiResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TaiwanLegalAiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TaiwanLegalAiError(code, msg, self)
