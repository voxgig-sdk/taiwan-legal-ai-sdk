...
from taiwanlegalai_sdk.utility import register

# Load features
from taiwanlegalai_sdk.feature.base_feature import TaiwanLegalAiBaseFeature
from taiwanlegalai_sdk.features import _has_feature, _make_feature
...
class TaiwanLegalAiSDK:
    ...
    def get_utility(self):
        return TaiwanLegalAiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TaiwanLegalAiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def CaseAnalysi(self, data=None) -> "CaseAnalysiEntity":
        ...
        from taiwanlegalai_sdk.entity.case_analysi_entity import CaseAnalysiEntity
    ...
    def ContractService(self, data=None) -> "ContractServiceEntity":
        ...
        from taiwanlegalai_sdk.entity.contract_service_entity import ContractServiceEntity
    ...
    def LegalQuery(self, data=None) -> "LegalQueryEntity":
        ...
        from taiwanlegalai_sdk.entity.legal_query_entity import LegalQueryEntity
