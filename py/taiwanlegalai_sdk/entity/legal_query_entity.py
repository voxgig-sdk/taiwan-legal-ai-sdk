...
class LegalQueryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LegalQueryEntity(self._client, opts)
    ...
    def create(self, reqdata: LegalQueryCreateData, ctrl=None) -> LegalQuery:
        utility = self._utility
