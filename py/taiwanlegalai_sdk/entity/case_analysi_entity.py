...
class CaseAnalysiEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CaseAnalysiEntity(self._client, opts)
    ...
    def match_get(self) -> CaseAnalysi:
    ...
    def create(self, reqdata: CaseAnalysiCreateData, ctrl=None) -> CaseAnalysi:
        utility = self._utility
