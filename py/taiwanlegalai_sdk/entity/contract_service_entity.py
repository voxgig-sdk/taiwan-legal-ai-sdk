...
from taiwanlegalai_sdk.taiwanlegalai_types import (
    ContractService,
...
class ContractServiceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ContractServiceEntity(self._client, opts)
    ...
    def data_get(self) -> ContractService:
    ...
    def match_get(self) -> ContractService:
    ...
    def create(self, reqdata: ContractServiceCreateData, ctrl=None) -> ContractService:
        utility = self._utility
