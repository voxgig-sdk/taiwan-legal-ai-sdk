...
class TaiwanLegalAiTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TaiwanLegalAiTestRunner.getenv("TAIWANLEGALAI_TEST_LIVE")
        override = TaiwanLegalAiTestRunner.getenv("TAIWANLEGALAI_TEST_OVERRIDE")
        ...
        explain = TaiwanLegalAiTestRunner.getenv("TAIWANLEGALAI_TEST_EXPLAIN")
