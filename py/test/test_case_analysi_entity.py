    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set TAIWAN_LEGAL_AI_TEST_CASE_ANALYSI_ENTID JSON to run live")
        client = setup["client"]
        ...
        case_analysi_ref01_data = helpers.to_map(runner.entity_data(case_analysi_ref01_ent.create(case_analysi_ref01_data, None)))
...
def _case_analysi_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "TAIWAN_LEGAL_AI_TEST_CASE_ANALYSI_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("TAIWAN_LEGAL_AI_TEST_CASE_ANALYSI_ENTID"))
