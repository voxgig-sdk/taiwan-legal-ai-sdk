# TaiwanLegalAi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TaiwanLegalAiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TaiwanLegalAiSDK(...) and TaiwanLegalAiSDK.test(...) become
#      TaiwanLegalAiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "taiwanlegalai_sdk"
_SDK_CLASS = "TaiwanLegalAiSDK"
