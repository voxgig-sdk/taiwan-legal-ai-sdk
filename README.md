...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/taiwan-legal-ai` | `npm install @voxgig-sdk/taiwan-legal-ai` |
| Python | `voxgig-sdk-taiwan-legal-ai` | `pip install voxgig-sdk-taiwan-legal-ai` |
| PHP | `voxgig-sdk/taiwan-legal-ai` | `composer require voxgig-sdk/taiwan-legal-ai` |
| Golang | `github.com/voxgig-sdk/taiwan-legal-ai-sdk/go` | `go get github.com/voxgig-sdk/taiwan-legal-ai-sdk/go` |
| Ruby | `voxgig-sdk-taiwan-legal-ai` | `gem install voxgig-sdk-taiwan-legal-ai` |
| Lua | `voxgig-sdk-taiwan-legal-ai` | `luarocks install voxgig-sdk-taiwan-legal-ai` |
