...
func registerSDKWords(r *eng.Registry, client *sdk.TaiwanLegalAiSDK) {
...
func runOp(client *sdk.TaiwanLegalAiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
