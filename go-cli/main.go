// Command TaiwanLegalAi-cli is a CLI + REPL for the TaiwanLegalAi SDK,
...
const prompt = "taiwan-legal-ai"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "case_analysi contract_service legal_query"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      TAIWAN_LEGAL_AI_APIKEY (api key), TAIWAN_LEGAL_AI_BASE (base url override)")
