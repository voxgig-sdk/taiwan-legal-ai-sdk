...
AQL-driven CLI and REPL for the TaiwanLegalAi SDK. Positional arguments are
...
```sh
go build -o taiwan-legal-ai-cli ./...
```
...
./taiwan-legal-ai-cli list case_analysi
./taiwan-legal-ai-cli load 1 case_analysi
./taiwan-legal-ai-cli load '{id:1}' case_analysi
