...
local ContractServiceEntity = {}
ContractServiceEntity.__index = ContractServiceEntity


function ContractServiceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ContractServiceEntity)
  self._name = "contract_service"
  self._client = client
...
function ContractServiceEntity:get_name()
  return self._name
end


function ContractServiceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ContractServiceEntity.new(self._client, opts)
end
...
function ContractServiceEntity:mark_deleted()
  self._deleted = true
end


function ContractServiceEntity:deleted()
  return true == self._deleted
end


function ContractServiceEntity:data_set(args)
  if args ~= nil then
...
function ContractServiceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ContractServiceEntity:match_set(args)
  if args ~= nil then
...
function ContractServiceEntity:match_get()
...
function ContractServiceEntity:stream(action, args, callopts)
...
function ContractServiceEntity:_run_op(ctx, post_done)
  local utility = self._utility
