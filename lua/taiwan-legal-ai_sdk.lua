...
local TaiwanLegalAiSDK = {}
TaiwanLegalAiSDK.__index = TaiwanLegalAiSDK
...
TaiwanLegalAiSDK._make_feature = _make_feature


function TaiwanLegalAiSDK.new(options)
  local self = setmetatable({}, TaiwanLegalAiSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function TaiwanLegalAiSDK:options_map()
...
function TaiwanLegalAiSDK:get_utility()
  return Utility.copy(self._utility)
end


function TaiwanLegalAiSDK:get_root_ctx()
  return self._rootctx
end


function TaiwanLegalAiSDK:prepare(fetchargs)
...
function TaiwanLegalAiSDK:direct(fetchargs)
...
-- by passing it.
function TaiwanLegalAiSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function TaiwanLegalAiSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "TaiwanLegalAiSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function TaiwanLegalAiSDK:CaseAnalysi(data)
  ...
  if data == nil then
    if self._case_analysi == nil then
      self._case_analysi = EntityMod.new(self, nil)
    end
    return self._case_analysi
  end
...
function TaiwanLegalAiSDK:ContractService(data)
  ...
  if data == nil then
    if self._contract_service == nil then
      self._contract_service = EntityMod.new(self, nil)
    end
...
function TaiwanLegalAiSDK:LegalQuery(data)
  ...
  if data == nil then
    if self._legal_query == nil then
      self._legal_query = EntityMod.new(self, nil)
    end
...
function TaiwanLegalAiSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = TaiwanLegalAiSDK.new(sdkopts)
  sdk.mode = "test"
