...
local SDK_MODULE = "taiwan-legal-ai_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["case_analysi"] = { ["test01"] = { id = "test01" } }, ["contract_service"] = { ["test01"] = { id = "test01" } }, ["legal_query"] = { ["test01"] = { id = "test01" } } } }'
