...
function runner.env_override(m)
  local live = runner.getenv("TAIWANLEGALAI_TEST_LIVE")
  local override = runner.getenv("TAIWANLEGALAI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TAIWANLEGALAI_TEST_EXPLAIN")
