...
function runner.env_override(m)
  local live = runner.getenv("TAIWAN_LEGAL_AI_TEST_LIVE")
  local override = runner.getenv("TAIWAN_LEGAL_AI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TAIWAN_LEGAL_AI_TEST_EXPLAIN")
